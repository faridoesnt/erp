                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group d-none">
                                <input id="password" type="password" name="password" class="form-control" value="{{ $supervisor->password }}" required autocomplete="new-password">
                            </div>
                            <div class="form-group d-none">
                                <input id="password-confirm" type="password" name="password_confirmation" class="form-control" value="{{ $supervisor->password }}" required autocomplete="new-password">
                            </div>
                            <div class="form-group d-none">
                                <select name="roles" class="form-control" required>
                                    <option value="{{ $supervisor->roles }}" selected>{{ $supervisor->roles }}</option>
                                </select>
                            </div>
